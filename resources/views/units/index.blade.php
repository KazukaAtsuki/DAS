    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <div class="bg-light-primary p-2 rounded-circle me-3 text-primary">
                <i class="ti ti-scale fs-1" style="color: #009688;"></i>
            </div>
            <div>
                <h3 class="fw-bolder mb-0 text-dark">Units Measurement</h3>
                <small class="text-muted">Manage standard units for sensors.</small>
            </div>
        </div>

        <a href="{{ route('units.create') }}" class="btn btn-teal d-flex align-items-center gap-2 rounded-pill px-4">
            <i class="ti ti-plus"></i> Create New Unit
        </a>
    </div>
    ...
    <div class="card card-modern">
        <div class="card-body p-4">
            <div class="table-responsive">
                <table class="table text-nowrap mb-0 align-middle table-hover table-modern" id="unitTable" style="width:100%">
                    <thead>
                        <tr>
                ...
                columns: [
                    { data: 'action', name: 'action', orderable: false, searchable: false, className: "text-center" },
                    {
                        ...
                        render: function(data) {
                            return '<span class="fw-bolder text-dark fs-4">' + data + '</span>';
                        }
                    },
